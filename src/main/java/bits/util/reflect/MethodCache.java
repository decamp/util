...
public class MethodCache {
     ...
     * @return best method found, or <code>null</code> if no invokable method found.
     */
    public Method match( Class<?> target, String methodName, Class<?>... params ) {
        return findBestMethod( target, 
                               methodName, 
     ...
     * @param methodName   Name of method to find.
     * @param params       Types of parameters to be passed to method.
     * @return best static method found, or <code>null</code> if no invokable method found.
     */
     ...
     * @param methodName   Name of method to find.
     * @param params       Arguments to be passed to method.
     * @return best method found, or <code>null</code> if no invokable method found.
     */    
    public Method matchArgs( Object target, String methodName, Object... args ) {
        return findBestMethod( target.getClass(), 
                               methodName, 
    ...
    public <T> Constructor<T> matchConstructorParams( Class<T> target, Class<?>... params ) {
        return findBestConstructor( target, 
                                    Methods.cleanParams( params ),
                                    false );
    }
                          ...
                          InvocationTargetException 
    {
        ...
        Method method = findBestMethod( target.getClass(), 
                                        methodName, 
                                        Methods.argTypes( args ), 
                                        false,
                                        true );
     ...
     * @throws InvocationTargetException
     */
    public Object invokeStatic( Class<?> target,
                                String methodName,
                                Object... args )
                                throws
                                NoSuchMethodException,
    ...
    {
        args = Methods.cleanArgs( args );
        Method method = findBestMethod( target, 
                                        methodName, 
                                        Methods.argTypes( args ), 
                                        true,
                                        true );
     ...
     * 
     * @param target Type of object to create.
     * @param args   Arguments to provide to constructor.
     * @return       New instance of type <code>target</code>.
     * 
     * @throws NoSuchMethodException
     * @throws IllegalAccessException
     * @throws InvocationTargetException
    ...
    private synchronized Method findBestMethod( Class<?> target,
                                                String methodName,
                                                Class<?>[] argTypes,
                                                boolean staticOnly,
    ...
    private synchronized <T> Constructor<T> findBestConstructor( Class<T> target, 
                                                                 Class<?>[] argTypes,
                                                                 boolean typeArrayIsSafe ) 
    {

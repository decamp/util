...
public class Methods {
     ...
     * @throws InvocationTargetException
     */
    public static Object invokeStatic( Class<?> target,
                                       String methodName,
                                       Object... args )
                                       throws
                                       NoSuchMethodException,
     ...
     * @param argTypes   Types of arguments to be provided to method. 
     ...
     * <code>null</code> objects are mapped to <code>void.class</code>.
     *  
     * @param args
     * @return
     */
    ...
    static Method findBestMethod( Class<?> target, 
                                  String methodName, 
                                  Class<?>[] argTypes, 
                                  boolean staticOnly )
    {
